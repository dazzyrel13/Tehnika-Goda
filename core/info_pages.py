...
_INFO_PAGES = {
    ...
    "avto_pod_zakaz": {
        "seo_title": "Авто из Китая. Прайс — авто под заказ | Техника Года",
        "seo_description": (
            "Авто из Китая под заказ: ориентировочный прайс BMW, Audi, Toyota, Haval "
            "и других марок. Проверка до оплаты, оформление документов, доставка "
            "автовозом по всей России."
        ),
        "article_headline": "Авто из Китая. Прайс",

...
_INFO_PAGES = {
    ...
    "services": {
        "seo_title": "Услуги по привозу автомобилей из Китая | Техника Года",
        "seo_description": (
            "Подбор, проверка до оплаты, ввоз и таможенное оформление автомобилей "
            "из Китая под ключ. Порядок работы, этапы оплаты и доставка по России."
        ),
        "article_headline": "Услуги по привозу автомобилей из Китая",
        "date_published": "2025-03-01",
        "date_modified": "2026-09-11",
    },
    "avto_pod_zakaz": {
        "seo_title": "Автомобили под заказ из Китая — прайс-лист цен | Техника Года",
        "seo_description": (
            "Авто под заказ из Китая: ориентировочный прайс BMW, Audi, Toyota, Haval "
            "и других марок. Проверка до оплаты, оформление документов, доставка "
            "автовозом по всей России."
        ),
        "article_headline": "Автомобили под заказ из Китая",

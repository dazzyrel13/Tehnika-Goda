...
CATEGORY_SEO: dict[str, tuple[str, str]] = {
    "cars": (
        "Легковые автомобили из Китая",
        "Подбор легковых авто с собственной площадки в Китае: проверка до оплаты, "
    ...
    "cars_new": (
        ...
        "Новые легковые автомобили без пробега с площадки в Китае. "
        "Подбор, проверка до оплаты и расчёт под ключ до выдачи в Благовещенске.",
    ),
    "cars_bought": (

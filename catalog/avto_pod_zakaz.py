"""SEO landing: авто из Китая + общий прайс."""
...
AVTO_POD_ZAKAZ_FAQS: list[tuple[str, str]] = [
    ...
    (
        "Что входит в цену авто из Китая?",
    ...
    (
        "Чем авто из Китая отличается от покупки в российском салоне?",
    ...
    (
        "Есть ли гарантия?",
        "На автомобили с нашей площадки (которые мы выкупили и которые у нас в собственности) "
        "действует гарантия 6 месяцев на ДВС и КПП. "
